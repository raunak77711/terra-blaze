...
| File        | Scene                        | Source                                                                                  |
|-------------|------------------------------|------------------------------------------------------------------------------------------|
| clip-01.mp4 | Mount Everest, snow-capped, breaking through cloud | https://www.pexels.com/video/breathtaking-view-of-mount-everest-and-surrounding-peaks-29632834/ |
| clip-02.mp4 | Snowy mountain range, drone   | https://www.pexels.com/video/drone-footage-of-a-snowy-mountain-range-16003270/           |
| clip-03.mp4 | Aerial view of snowy mountains | https://www.pexels.com/video/aerial-view-of-snowy-mountains-7593088/                     |
...
- **Homepage hero montage** (`index.html` + `js/hero-cinema.js`): clip-01 → 06
  in sequence. Phones stream the lighter reel (clip-01, 02, 06 only).
...
The original `clip-01.mp4` ("Sea of clouds and mountains during golden hour")
was replaced with the Everest clip above on 2026-07-22 (recoverable from git history).
